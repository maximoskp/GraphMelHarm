...
class SimpleParticipationMPNN(MessagePassing):
    ...
    def update(self,
        ...
        return self.update_mlp(z)
    # end update
# end class SimpleParticipationMPNN

# ============================================================
# TEMPORAL MESSAGE PASSING
# ============================================================

class SimpleTemporalMPNN(MessagePassing):
    ...
    def message(self,
        ...
        return self.message_mlp(z)
    # end message
# end class SimpleTemporalMPNN

# ============================================================
# FULL MODEL
# ============================================================

class SimpleHarmonicGraphEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.participation_mpnn = SimpleParticipationMPNN(
            pitch_dim=hidden_dim,
            event_dim=hidden_dim,
            hidden_dim=hidden_dim
        )
        ...
        self.temporal_mpnn = SimpleTemporalMPNN(
            hidden_dim=hidden_dim
        )
    ...
    def forward(self, data):
        ...
        return z
    # end forward
# end class SimpleHarmonicGraphEncoder
...
class DICParticipationMPNN(MessagePassing):
    ...
    def update(self,
        ...
        return self.update_mlp(z)
    # end update
# end class DICParticipationMPNN

# ============================================================
# TEMPORAL MESSAGE PASSING
# ============================================================

class DICTemporalMPNN(MessagePassing):
    ...
    def message(self,
        ...
        return self.message_mlp(z)
    # end message
# end class DICTemporalMPNN

# ============================================================
# FULL MODEL
# ============================================================

class DICHarmonicGraphEncoder(nn.Module):
    ...
    def __init__(self,
        ...
        self.participation_mpnn = DICParticipationMPNN(
            pitch_dim=hidden_dim,
            event_dim=hidden_dim,
            hidden_dim=hidden_dim
        )
        ...
        self.temporal_mpnn = DICTemporalMPNN(
            hidden_dim=hidden_dim,
            edge_dim=12
        )
    ...
    def forward(self, data):
        ...
        return z
    # end forward
# end class DICHarmonicGraphEncoder