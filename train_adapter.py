...
def main():
    ...
    # save results
    results_path = os.path.join( 'results', version, 'adapter' + '_mel'*use_melody + '_contra'*use_contra + '_' + datasets + '.csv' )
    os.makedirs('results', exist_ok=True)
    os.makedirs(f'results/{version}/', exist_ok=True)

    save_dir = f'saved_models/{version}/adapter/'
    os.makedirs('saved_models/', exist_ok=True)
    os.makedirs(f'saved_models/{version}/', exist_ok=True)
    os.makedirs(f'saved_models/{version}/adapter/', exist_ok=True)
