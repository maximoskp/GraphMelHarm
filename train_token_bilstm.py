...
def main():
    ...
    if 'h' in datasets:
        ...
        train_dataset_hook = TokenBiLSTMDataset(train_d_hook, tokenizer, include_melody=use_melody)
        val_dataset_hook = TokenBiLSTMDataset(val_d_hook, tokenizer, include_melody=use_melody)
    ...
    if 'j' in datasets:
        ...
        train_dataset_gjt = TokenBiLSTMDataset(train_d_gjt, tokenizer, include_melody=use_melody)
        val_dataset_gjt = TokenBiLSTMDataset(val_d_gjt, tokenizer, include_melody=use_melody)
    ...
    if 'n' in datasets:
        ...
        train_dataset_nottingham = TokenBiLSTMDataset(train_d_nottingham, tokenizer, include_melody=use_melody)
        val_dataset_nottingham = TokenBiLSTMDataset(val_d_nottingham, tokenizer, include_melody=use_melody)
