...
from data_utils import TokenBiLSTMDataset, token_bilstm_collate_fn
...
def main():
    ...
    if 'h' in datasets:
        ...
        train_dataset_hook = TokenBiLSTMDataset(train_d_hook, tokenizer, transformer_model, include_melody=use_melody)
        val_dataset_hook = TokenBiLSTMDataset(val_d_hook, tokenizer, transformer_model, include_melody=use_melody)
    ...
    if 'j' in datasets:
        ...
        train_dataset_gjt = TokenBiLSTMDataset(train_d_gjt, tokenizer, transformer_model, include_melody=use_melody)
        val_dataset_gjt = TokenBiLSTMDataset(val_d_gjt, tokenizer, transformer_model, include_melody=use_melody)
    ...
    if 'n' in datasets:
        ...
        train_dataset_nottingham = TokenBiLSTMDataset(train_d_nottingham, tokenizer, transformer_model, include_melody=use_melody)
        val_dataset_nottingham = TokenBiLSTMDataset(val_d_nottingham, tokenizer, transformer_model, include_melody=use_melody)
    ...
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, collate_fn=token_bilstm_collate_fn)
    val_loader = DataLoader(val_dataset, batch_size=batch_size, shuffle=False, collate_fn=token_bilstm_collate_fn)
    ...
    save_dir = f'saved_models/{version}/token_bilstm/'
