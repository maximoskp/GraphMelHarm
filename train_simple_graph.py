...
from models_graph import SimpleHarmonicGraphEncoder
...
def main():
    ...
    # save results
    results_path = os.path.join( 'results', version, 'simple_graph' + '_mel'*use_melody + '_contra'*use_contra + '_' + datasets + '.csv' )
    os.makedirs('results', exist_ok=True)
    os.makedirs(f'results/{version}/', exist_ok=True)

    save_dir = f'saved_models/{version}/simple_graph/'
    os.makedirs('saved_models/', exist_ok=True)
    os.makedirs(f'saved_models/{version}/', exist_ok=True)
    os.makedirs(f'saved_models/{version}/simple_graph/', exist_ok=True)
