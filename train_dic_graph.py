...
from models_graph import DICHarmonicGraphEncoder
...
def main():
    ...
    # save results
    results_path = os.path.join( 'results', version, 'dic_graph' + '_mel'*use_melody + '_contra'*use_contra + '_' + datasets + '.csv' )
    ...
    os.makedirs(f'saved_models/{version}/dic_graph/', exist_ok=True)
