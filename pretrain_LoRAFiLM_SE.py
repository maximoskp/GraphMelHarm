...
def main():
    ...
    os.makedirs('results/LoRAFiLM_SE/', exist_ok=True)
    results_path = 'results/LoRAFiLM_SE/' + 'pretraining.csv'

    os.makedirs('saved_models/', exist_ok=True)
    os.makedirs('saved_models/LoRAFiLM_SE/', exist_ok=True)
    save_dir = 'saved_models/LoRAFiLM_SE/'
