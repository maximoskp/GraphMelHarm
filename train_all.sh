...
scripts=(
    "train_graph.py -m 0 -g 0 -e 100 -l 1e-5 -b 16"
    "train_bilstm.py -m 0 -g 0 -e 100 -l 1e-5 -b 16"
    "train_graph.py -m 1 -g 0 -e 100 -l 1e-5 -b 16"
    "train_bilstm.py -m 1 -g 0 -e 100 -l 1e-5 -b 16"
)
