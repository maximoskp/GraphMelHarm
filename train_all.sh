...
scripts=(
    ...
    # "train_graph.py -v FiLM -d jnhw -m 0 -c 0 -g 1 -e 100 -l 1e-4 -b 16"
    "train_bilstm.py -v FiLM -d jnhw -m 0 -c 0 -g 1 -e 100 -l 1e-4 -b 16"
    # "train_token_bilstm.py -v FiLM -d jnhw -m 0 -c 0 -g 1 -e 100 -l 1e-4 -b 16"

    # "train_graph.py -v FiLM -d jnhw -m 0 -c 1 -g 2 -e 100 -l 1e-4 -b 16"
    "train_bilstm.py -v FiLM -d jnhw -m 0 -c 1 -g 2 -e 100 -l 1e-4 -b 16"
