...
def main():
    ...
    os.makedirs('results/pretraining_FiLM/', exist_ok=True)
    results_path = 'results/pretraining_FiLM/' + 'pretraining.csv'

    os.makedirs('saved_models/', exist_ok=True)
    os.makedirs('saved_models/FiLM_pretrained/', exist_ok=True)
    save_dir = 'saved_models/FiLM_pretrained/'
