...
from generate_utils import load_LHFiLMLoRASEModel
import torch
...
def main():
    ...
    # load the model
    transformer_model = load_LHFiLMLoRASEModel(
        tokenizer=tokenizer,
    ...
    # save results
    results_path = os.path.join( 'results', 'LHFiLMLoRA', 'graph' + '_mel'*use_melody + '.csv' )
    os.makedirs('results', exist_ok=True)
    os.makedirs('results/LHFiLMLoRA', exist_ok=True)

    os.makedirs('saved_models/', exist_ok=True)
    os.makedirs('saved_models/LHFiLMLoRA/', exist_ok=True)
    os.makedirs('saved_models/LHFiLMLoRA/graph/', exist_ok=True)
    save_dir = 'saved_models/LHFiLMLoRA/graph/'
